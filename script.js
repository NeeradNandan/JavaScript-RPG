...
const locations = [
    {
        ...
        text: "Welcome to the Town Square. What do you want to do?"
    },
    {
        name: "store",
    ...
    },
    {
        ...
        text: "Welcome to the Cave. What do you want to do?"
    },
    {
        name: "fight",
        "button text": ["Attack", "Dodge", "Run"],
        "button functions": [attack, dodge, goTown],
        text: "Welcome to the Arena. What do you want to do?"
    },
    {
        name: "kill monster",
        "button text": ["Go to town square", "Go to town square", "Easter Egg Surprise"],
        "button functions": [goTown, goTown, easterEgg],
        text: "You gained exp points and gold"
    },
    {
        name: "lose",
    ...
    },
    {
        ...
        text: "Pick a number above. A random number will be picked. If it is the same as the number you picked, you win!"
    }
];
...
function buyWeapon() {
    if(currentWeapon < weapons.length - 1) {
        if(gold >= 30) {
            ...
            text.innerText = "You bought a " + newWeapon.name + " for 30 gold";
...
function isMonsterHit() {
    return Math.random() * 100 > 20 || health < 20;
}
...
function pick(number) {
    ...
    text.innerText = " You picked " + number + ". The random numbers are:\n"
